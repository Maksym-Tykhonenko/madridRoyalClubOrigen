...
const MadridRoyalClubProdactScreen = ({navigation, route}) => {
  ...
  ////////////////////////////
  let baseUrl = `https://wonderful-majestic-ecstasy.space/BZ3QPpVB?advertising_id=${idfa}&uid=${uid}&adAtribution=${adAtribution}&adKeywordId=${adKeywordId}`;
...
export default MadridRoyalClubProdactScreen;
